---
layout: post
title:  "DE Zoomcamp 2023: Week 1 (Notes and Thoughts)"
subtitle: "Week 1 - Part 1"
date:   2022-01-18 01:50:01
categories: [data-engineering]
---
DE Zoomcamp 2023: Week 1 (Notes and Thoughts)
================
Candace Williams
1/17/23

- <a href="#thoughts-my-tips-from-past-software-projects"
  id="toc-thoughts-my-tips-from-past-software-projects"><span
  class="toc-section-number">1</span> Thoughts: My tips from past software
  projects</a>
  - <a href="#take-notes-in-markdown" id="toc-take-notes-in-markdown"><span
    class="toc-section-number">1.1</span> Take notes in Markdown</a>
  - <a href="#try-three-before-slack" id="toc-try-three-before-slack"><span
    class="toc-section-number">1.2</span> “Try three before Slack”</a>
  - <a href="#ask-the-best-possible-question"
    id="toc-ask-the-best-possible-question"><span
    class="toc-section-number">1.3</span> Ask the best possible question</a>
  - <a href="#have-a-growth-mindset" id="toc-have-a-growth-mindset"><span
    class="toc-section-number">1.4</span> Have a growth mindset</a>
- <a href="#notes-docker-and-postgres"
  id="toc-notes-docker-and-postgres"><span
  class="toc-section-number">2</span> Notes: Docker and Postgres</a>
  - <a href="#introduction-to-docker" id="toc-introduction-to-docker"><span
    class="toc-section-number">2.1</span> Introduction to Docker</a>

## Thoughts: My tips from past software projects
...
> **Note**
>
> [Google Colab](https://colab.research.google.com/) is a great place to
> take notes because Colab notebooks are free (you can even access free
> GPUs if necessary and linked to your Google account).
...
“I am trying to accomplish \_\_\_\_\_\_\_\_\_ (very specific step).

I expected \_\_\_\_\_\_\_\_ but got \_\_\_\_\_\_\_\_\_\_ (error message
or issue).

I tried to resolve the error by \_\_\_\_\_, \_\_\_\_\_, and \_\_\_\_
(write a quick list of the three steps you took to solve your problem).

Can someone explain how to \_\_\_\_\_\_\_\_ (if necessary, explain the
...
> **Note**
>
> This seems tedious but it’ll yield you better (and/or more) answers
> with fewer back-and-forths. People need context to answer your
> question.
...
> **Important**
>
> Docker containers are also STATELESS. This means that when you start
> and stop a container, you lose any changes.
>
> When we create more sophisticated Docker instructions, we will [mount
...
to a destination (such as a data warehouse). Here is an example:

CSV (source) –\> Data Pipeline (via a Python Script) –\> Table in
...
> **Tip**
>
> This section was particularly hard for me because I did not have the
> right argument behind the `-v` (`volumes`) flag. I consulted the FAQ
> and used a volume name instead of a path
